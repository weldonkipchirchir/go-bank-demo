...
createdb:
	docker exec -it postgresv3 createdb --username=root --owner=root simple_bank

dropdb:
	docker exec -it postgresv3 dropdb simple_bank
...
mock:
	mockgen --package mockdb --destination db/mock/store.go  github.com/weldonkipchirchir/simple_bank/db/sqlc Store 	
